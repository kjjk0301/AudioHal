...
#ifdef EFFECTS_PREPROCESS_SUPPORT
#define RK_NEW_EFFECT_ENABLE    // using audio_effect api
#undef RK_DENOISE_ENABLE
#endif


#ifndef RK_NEW_EFFECT_ENABLE
#define RK_COMMON_AEC_ENABLE    // re-using phone AEC algorithm, but not audio_effect api
#endif


#ifdef RK_COMMON_AEC_ENABLE
//#define RK_COMMON_AEC_TEST
#endif


#define BUIDIN_MIC_VOLUME_PROCESS
#ifdef BUIDIN_MIC_VOLUME_PROCESS
#define BUIDIN_MIC_VOLUME_FADEIN_ENABLE
#endif
